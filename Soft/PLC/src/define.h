...
// 08
// 09
#define _ALG_STEP      cellAna[10].var // 10 - шаг алгоритма
...
#define _SAU_WORK      cellBool[05].var  // 05 - Работа автоматики САУ - 1, Работа автоматики ППИО системы -0
// 06 - Индикатор работы насоса
// 07 - Нажата кнопка вверх
// 08 - Нажата кнопка вниз
// 09 - Нажата кнопка применить
// 10 -
// 11 -
// 12 -
// 13 -
